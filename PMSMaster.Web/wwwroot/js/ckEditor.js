...
(function () {
    if (window.CKEDITOR && window.CKEDITOR.dom) return; window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "M199", version: "4.17.2", revision: "cb93181c83", rnd: Math.floor(900 * Math.random()) + 100, _: { pending: [], basePathSrcPattern: a }, status: "unloaded", basePath: function () {
        ...
        var a = {}; CKEDITOR.event || (CKEDITOR.event = function () { }, CKEDITOR.event.implementOn = function (a) { var b = CKEDITOR.event.prototype, c; for (c in b) null == a[c] && (a[c] = b[c]) }, CKEDITOR.event.prototype = function () {
            function d(a) { var e = b(this); return e[a] || (e[a] = new c(a)) } var b = function (a) { a = a.getPrivate && a.getPrivate() || a._ || (a._ = {}); return a.events || (a.events = {}) }, c = function (a) { this.name = a; this.listeners = [] }; c.prototype = {
                ...
                define: function (a, b) { var c = d.call(this, a); CKEDITOR.tools.extend(c, b, !0) }, on: function (b, c, k, h, l) {
                    function q(w, x, z, l) { w = { name: b, sender: this, editor: w, data: x, listenerData: h, stop: z, cancel: l, removeListener: g }; return !1 === c.call(k, w) ? a : w.data } function g() { w.removeListener(b, c) } var w = this, x = d.call(this, b); if (0 > x.getListenerIndex(c)) {
                        x = x.listeners; k || (k = this); isNaN(l) && (l = 10); q.fn = c; q.priority = l; for (var z = x.length - 1; 0 <= z; z--)if (x[z].priority <= l) return x.splice(z + 1, 0, q), { removeListener: g };
                        x.unshift(q)
                    ...
                    var c = 0, e = function () { c = 1 }, d = 0, h = function () { d = 1 }; return function (l, q, g) {
                        var w = b(this)[l]; l = c; var x = d; c = d = 0; if (w) {
                            var z = w.listeners; if (z.length) for (var z = z.slice(0),
                                A, t = 0; t < z.length; t++) { if (w.errorProof) try { A = z[t].call(this, g, q, e, h) } catch (m) { } else A = z[t].call(this, g, q, e, h); A === a ? d = 1 : "undefined" != typeof A && (q = A); if (c || d) break }
                        } q = d ? !1 : "undefined" == typeof q ? !0 : q; c = l; d = x; return q
                    }
    ...
    (function () {
        function a(a, x, b) { this._minInterval = a; this._context = b; this._lastOutput = this._scheduledTimer = 0; this._output = CKEDITOR.tools.bind(x, b || {}); var c = this; this.input = function () { function a() { c._lastOutput = (new Date).getTime(); c._scheduledTimer = 0; c._call() } if (!c._scheduledTimer || !1 !== c._reschedule()) { var w = (new Date).getTime() - c._lastOutput; w < c._minInterval ? c._scheduledTimer = setTimeout(a, c._minInterval - w) : a() } } } function d(w, x, b) {
            a.call(this, w, x, b); this._args = []; var c = this; this.input = CKEDITOR.tools.override(this.input,
                function (a) { return function () { c._args = Array.prototype.slice.call(arguments); a.call(this) } })
        } var b = [], c = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", f = /&/g, e = />/g, k = /</g, h = /"/g, l = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, q = { lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­" }, g = function (a, x) { return "#" == x[0] ? String.fromCharCode(parseInt(x.slice(1), 10)) : q[x] }; CKEDITOR.on("reset", function () { b = [] }); CKEDITOR.tools = {
            arrayCompare: function (a, x) {
                if (!a && !x) return !0;
                if (!a || !x || a.length != x.length) return !1; for (var b = 0; b < a.length; b++)if (a[b] != x[b]) return !1; return !0
            }, getIndex: function (a, x) { for (var b = 0; b < a.length; ++b)if (x(a[b])) return b; return -1 }, clone: function (a) {
                ...
                c) { return b.push(function () { return a.apply(c || this, arguments) }) - 1 }, removeFunction: function (a) { b[a] = null }, callFunction: function (a) { var c = b[a]; return c && c.apply(window, Array.prototype.slice.call(arguments, 1)) }, cssLength: function () { var a = /^-?\d+\.?\d*px$/, b; return function (c) { b = CKEDITOR.tools.trim(c + "") + "px"; return a.test(b) ? b : c || "" } }(), convertToPx: function () {
                    ...
                    var g = {}; c && (a = (new CKEDITOR.dom.element("span")).setAttribute("style", a).getAttribute("style") || ""); a && (a = CKEDITOR.tools.normalizeHex(CKEDITOR.tools.convertRgbToHex(a))); if (!a || ";" == a) return g; a.replace(/&quot;/g, '"').replace(/\s*([^:;\s]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, c, w) {
                        b && (c =
                            c.toLowerCase(), "font-family" == c && (w = w.replace(/\s*,\s*/g, ",")), w = CKEDITOR.tools.trim(w)); g[c] = w
                    }); return g
    ...
    (function () {
        function a(a, b) {
            var c = this.range; if (this._.end) return null; if (!this._.start) { this._.start = 1; if (c.collapsed) return this.end(), null; c.optimize() } var g, d = c.startContainer; g = c.endContainer; var e = c.startOffset, f = c.endOffset, w, h = this.guard, k = this.type, q = a ? "getPreviousSourceNode" : "getNextSourceNode"; if (!a && !this._.guardLTR) {
                var l = g.type == CKEDITOR.NODE_ELEMENT ? g : g.getParent(), y = g.type == CKEDITOR.NODE_ELEMENT ? g.getChild(f) : g.getNext(); this._.guardLTR = function (a, b) {
                    return (!b || !l.equals(a)) && (!y ||
                        !a.equals(y)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
        ...
        CKEDITOR.dom.walker.bookmark = function (a, b) { function c(a) { return a && a.getName && "span" == a.getName() && a.data("cke-bookmark") } return function (g) { var d, e; d = g && g.type != CKEDITOR.NODE_ELEMENT && (e = g.getParent()) && c(e); d = a ? d : d || c(g); return !!(b ^ d) } }; CKEDITOR.dom.walker.whitespaces = function (a) { return function (b) { var c; b && b.type == CKEDITOR.NODE_TEXT && (c = !CKEDITOR.tools.trim(b.getText()) || CKEDITOR.env.webkit && b.getText() == CKEDITOR.dom.selection.FILLING_CHAR_SEQUENCE); return !!(a ^ c) } }; CKEDITOR.dom.walker.invisible =
            function (a) { var b = CKEDITOR.dom.walker.whitespaces(), c = CKEDITOR.env.webkit ? 1 : 0; return function (g) { b(g) ? g = 1 : (g.type == CKEDITOR.NODE_TEXT && (g = g.getParent()), g = g.$.offsetWidth <= c); return !!(a ^ g) } }; CKEDITOR.dom.walker.nodeType = function (a, b) { return function (c) { return !!(b ^ c.type == a) } }; CKEDITOR.dom.walker.bogus = function (a) {
                ...
                function (a) { return function (b) { b = e(b) || k(b) || h(b); return !!(a ^ b) } }; var q = CKEDITOR.dom.walker.ignored(); CKEDITOR.dom.walker.empty = function (a) { return function (b) { for (var c = 0, g = b.getChildCount(); c < g; ++c)if (!q(b.getChild(c))) return !!a; return !a } }; var g = CKEDITOR.dom.walker.empty(), w = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) { var b = {}, c; for (c in a) CKEDITOR.dtd[c]["#"] && (b[c] = 1); return b }(CKEDITOR.dtd.$block), { caption: 1, td: 1, th: 1 }); CKEDITOR.dom.walker.editable = function (a) {
                    return function (b) {
                        b =
                        q(b) ? !1 : b.type == CKEDITOR.NODE_TEXT || b.type == CKEDITOR.NODE_ELEMENT && (b.is(CKEDITOR.dtd.$inline) || b.is("hr") || "false" == b.getAttribute("contenteditable") || !CKEDITOR.env.needsBrFiller && b.is(w) && g(b)) ? !0 : !1; return !!(a ^ b)
                    }
    ...
    (function () {
        function a(a) { a.collapsed = a.startContainer && a.endContainer && a.startContainer.equals(a.endContainer) && a.startOffset == a.endOffset } function d(a, b, c, d, e) {
            function f(a, b, c, g) { var L = c ? a.getPrevious() : a.getNext(); if (g && k) return L; l || g ? b.append(a.clone(!0, e), c) : (a.remove(), q && b.append(a, c)); return L } function m() { var a, b, c, g = Math.min(O.length, p.length); for (a = 0; a < g; a++)if (b = O[a], c = p[a], !b.equals(c)) return a; return a - 1 } function h() {
            ...
            } a.optimizeBookmark(); var k = 0 === b, q = 1 == b, l = 2 == b; b = l || q; var u = a.startContainer, F = a.endContainer,
                H = a.startOffset, y = a.endOffset, K, r, D, B, G, T; if (l && F.type == CKEDITOR.NODE_TEXT && (u.equals(F) || u.type === CKEDITOR.NODE_ELEMENT && u.getFirst().equals(F))) c.append(a.document.createText(F.substring(H, y))); else {
                    F.type == CKEDITOR.NODE_TEXT ? l ? T = !0 : F = F.split(y) : 0 < F.getChildCount() ? y >= F.getChildCount() ? (F = F.getChild(y - 1), r = !0) : F = F.getChild(y) : B = r = !0; u.type == CKEDITOR.NODE_TEXT ? l ? G = !0 : u.split(H) : 0 < u.getChildCount() ? 0 === H ? (u = u.getChild(H), K = !0) : u = u.getChild(H - 1) : D = K = !0; for (var O = u.getParents(), p = F.getParents(), I = m(),
        ...
        function f(a) { return function () { var b; return this[a ? "getPreviousNode" : "getNextNode"](function (a) { !b && q(a) && (b = a); return l(a) && !(k(a) && a.equals(b)) }) } } var e = { abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1 }, k = CKEDITOR.dom.walker.bogus(), h = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, l = CKEDITOR.dom.walker.editable(), q = CKEDITOR.dom.walker.ignored(!0); CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                function c(a) { return a && a.type == CKEDITOR.NODE_ELEMENT && a.hasAttribute("contenteditable") ? null : a } var d = new RegExp(/[^\s\ufeff]/); switch (a) {
                    ...
                    }; if (this.collapsed) break; var m = this.getCommonAncestor(), h = this.root, k, q, l, u, F, H = !1, y, K; y = this.startContainer; var r = this.startOffset; y.type == CKEDITOR.NODE_TEXT ? (r && (y = !CKEDITOR.tools.trim(y.substring(0, r)).length && y, H = !!y), y && ((u = y.getPrevious()) || (l = y.getParent()))) : (r && (u = y.getChild(r - 1) || y.getLast()), u || (l = y));
                        for (l = c(l); l || u;) {
                            if (l && !u) { !F && l.equals(m) && (F = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break; H && "inline" == l.getComputedStyle("display") || (H = !1, F ? k = l : this.setStartBefore(l)); u = l.getPrevious() } for (; u;)if (y = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious(); else {
                                if (u.type == CKEDITOR.NODE_TEXT) K = u.getText(), d.test(K) && (u = null), y = /[\s\ufeff]$/.test(K); else if ((u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && u.is("br")) && !u.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                    K = u.getText();
                                    if (d.test(K)) u = null; else for (var r = u.$.getElementsByTagName("*"), D = 0, B; B = r[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { u = null; break } u && (y = !!K.length)
                                } else u = null; y && (H ? F ? k = l : l && this.setStartBefore(l) : H = !0); if (u) { y = u.getPrevious(); if (!l && !y) { l = u; u = null; break } u = y } else l = null
                            } l && (l = c(l.getParent()))
                        } y = this.endContainer; r = this.endOffset; l = u = null; F = H = !1; y.type == CKEDITOR.NODE_TEXT ? CKEDITOR.tools.trim(y.substring(r)).length ? H = !0 : (H = !y.getLength(), r == y.getLength() ? (u = y.getNext()) || (l = y.getParent()) :
                            f(y, r) && (l = y.getParent())) : (u = y.getChild(r)) || (l = y); for (; l || u;) {
                                if (l && !u) { !F && l.equals(m) && (F = !0); if (e ? l.isBlockBoundary() : !h.contains(l)) break; H && "inline" == l.getComputedStyle("display") || (H = !1, F ? q = l : l && this.setEndAfter(l)); u = l.getNext() } for (; u;) {
                                    y = !1; if (u.type == CKEDITOR.NODE_TEXT) K = u.getText(), f(u, 0) || (u = null), y = /^[\s\ufeff]/.test(K); else if (u.type == CKEDITOR.NODE_ELEMENT) {
                                        if ((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark")) if (H && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                            K = u.getText(); if (d.test(K)) u =
                                                null; else for (r = u.$.getElementsByTagName("*"), D = 0; B = r[D++];)if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) { u = null; break } u && (y = !!K.length)
                                        } else u = null
                                    } else y = 1; y && H && (F ? q = l : this.setEndAfter(l)); if (u) { y = u.getNext(); if (!l && !y) { l = u; u = null; break } u = y } else l = null
                                } l && (l = c(l.getParent()))
                            } k && q && (m = k.contains(q) ? q : k, this.setStartBefore(m), this.setEndAfter(m)); break; case CKEDITOR.ENLARGE_BLOCK_CONTENTS: case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS: l = new CKEDITOR.dom.range(this.root); h = this.root; l.setStartAt(h,
                                CKEDITOR.POSITION_AFTER_START); l.setEnd(this.startContainer, this.startOffset); l = new CKEDITOR.dom.walker(l); var G, T, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? { br: 1 } : null), p = null, I = function (a) { if (a.type == CKEDITOR.NODE_ELEMENT && "false" == a.getAttribute("contenteditable")) if (p) { if (p.equals(a)) { p = null; return } } else p = a; else if (p) return; var b = O(a); b || (G = a); return b }, e = function (a) { var b = I(a); !b && a.is && a.is("br") && (T = a); return b }; l.guard = I; l = l.lastBackward(); G = G || h; this.setStartAt(G,
                                    !G.is("br") && (!l && this.checkStartOfBlock() || l && G.contains(l)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END); if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone(); l = new CKEDITOR.dom.walker(l); var N = CKEDITOR.dom.walker.whitespaces(), n = CKEDITOR.dom.walker.bookmark(); l.evaluator = function (a) { return !N(a) && !n(a) }; if ((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone(); l.collapse(); l.setEndAt(h, CKEDITOR.POSITION_BEFORE_END); l = new CKEDITOR.dom.walker(l); l.guard =
                                        a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? e : I; G = p = T = null; l = l.lastForward(); G = G || h; this.setEndAt(G, !l && this.checkEndOfBlock() || l && G.contains(l) ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_BEFORE_START); T && this.setEndAfter(T)
                }
        ...
        function a(a) { 1 > arguments.length || (this.range = a, this.forceBrBreak = 0, this.enlargeBr = 1, this.enforceRealBlocks = 0, this._ || (this._ = {})) } function d(a) { var b = []; a.forEach(function (a) { if ("true" == a.getAttribute("contenteditable")) return b.push(a), !1 }, CKEDITOR.NODE_ELEMENT, !0); return b } function b(a, c, e, f) {
            ...
            h = function (a) { return e(a) && k(a) }, l = { dd: 1, dt: 1, li: 1 }; a.prototype = {
                getNextParagraph: function (a) {
                    var d, k, x, z, A; a = a || "p"; if (this._.nestedEditable) {
                        ...
                        x = (!M || J) && m.equals(t); if (k && !M) for (; !m.getNext(h) && !x;) { u = m.getParent(); if (u.isBlockBoundary(this.forceBrBreak && !v && { br: 1 })) { M = 1; J = 0; x || u.equals(t); k.setEndAt(u, CKEDITOR.POSITION_BEFORE_END); break } m = u; J = 1; x = m.equals(t); E = 1 } J && k.setEndAt(m, CKEDITOR.POSITION_AFTER_END); m = this._getNextSourceNode(m, E, t); if ((x = !m) || M && k) break
                    } if (!d) {
    ...
    (function () {
        function a(a, b, c, d, e) {
            var f, g; a = []; for (f in b) {
                g = b[f]; g = "boolean" == typeof g ? {} : "function" == typeof g ? { match: g } : D(g); "$" != f.charAt(0) && (g.elements = f); c && (g.featureName = c.toLowerCase()); var n = g; n.elements = k(n.elements, /\s+/) || null; n.propertiesOnly = n.propertiesOnly || !0 === n.elements; var r = /\s*,\s*/, p = void 0; for (p in T) {
                    n[p] = k(n[p], r) || null; var B = n, m = O[p], y = k(n[O[p]], r), h = n[p], C = [], G = !0, I = void 0; y ? G = !1 : y = {}; for (I in h) "!" == I.charAt(0) && (I = I.slice(1), C.push(I), y[I] = !0, G = !1); for (; I = C.pop();)h[I] =
                        h["!" + I], delete h["!" + I]; B[m] = (G ? !1 : y) || null
                } n.match = n.match || null; d.push(g); a.push(g)
            } b = e.elements; e = e.generic; var l; c = 0; for (d = a.length; c < d; ++c) {
                f = D(a[c]); g = !0 === f.classes || !0 === f.styles || !0 === f.attributes; n = f; p = m = r = void 0; for (r in T) n[r] = M(n[r]); B = !0; for (p in O) { r = O[p]; m = n[r]; y = []; h = void 0; for (h in m) -1 < h.indexOf("*") ? y.push(new RegExp("^" + h.replace(/\*/g, ".*") + "$")) : y.push(h); m = y; m.length && (n[r] = m, B = !1) } n.nothingRequired = B; n.noProperties = !(n.attributes || n.classes || n.styles); if (!0 === f.elements ||
            ...
            b) { if (!a) return !1; var c = !1, d = !0 === a, e; for (e in b) if (d || a(e)) delete b[e], c = !0; return c } function e(a, b, c) { if (a.disabled || a.customConfig && !c || !b) return !1; a._.cachedChecks = {}; return !0 } function k(a, b) { if (!a) return !1; if (!0 === a) return a; if ("string" == typeof a) return a = B(a), "*" == a ? !0 : CKEDITOR.tools.convertArrayToObject(a.split(b)); if (CKEDITOR.tools.isArray(a)) return a.length ? CKEDITOR.tools.convertArrayToObject(a) : !1; var c = {}, d = 0, e; for (e in a) c[e] = a[e], d++; return d ? c : !1 } function h(a, b) {
            ...
            } function g(a) { var b, c, d, e, f = {}, g = 1; for (a = B(a); b = a.match(p);)(c = b[2]) ? (d = w(c, "styles"), e = w(c, "attrs"), c = w(c, "classes")) : d = e = c = null, f["$" + g++] = { elements: b[1], classes: c, styles: d, attributes: e }, a = a.slice(b[0].length); return f } function w(a, b) { var c = a.match(I[b]); return c ? B(c[1]) : null } function x(a) {
                ...
                var g = 0, r; f.toHtml && (b.name = b.name.replace(N, "$1")); if (f.doCallbacks && a.elementCallbacks) { a: { r = a.elementCallbacks; for (var p = 0, B = r.length, D; p < B; ++p)if (D = r[p](b)) { r = D; break a } r = void 0 } if (r) return r } if (f.doTransform && (r = a._.transformations[b.name])) { x(b); for (p = 0; p < r.length; ++p)u(a, b, r[p]); t(b) } if (f.doFilter) {
                    a: {
                        p = b.name; B = a._; a = B.allowedRules.elements[p]; r = B.allowedRules.generic; p = B.disallowedRules.elements[p]; B = B.disallowedRules.generic;
                        D = f.skipRequired; var k = { valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1 }, y, h; if (a || r) { x(b); if (p) for (y = 0, h = p.length; y < h; ++y)if (!1 === c(p[y], b, k)) { a = null; break a } if (B) for (y = 0, h = B.length; y < h; ++y)c(B[y], b, k); if (a) for (y = 0, h = a.length; y < h; ++y)d(a[y], b, k, D); if (r) for (y = 0, h = r.length; y < h; ++y)d(r[y], b, k, D); a = k } else a = null
                    ...
                    r = a.validClasses; var p = b.attributes, G = b.styles, B = b.classes; D = b.classBackup; var O = b.styleBackup, I, l, K = [], k = [], T = /^data-cke-/; y = !1; delete p.style; delete p["class"]; delete b.classBackup; delete b.styleBackup; if (!a.allAttributes) for (I in p) h[I] || (T.test(I) ? I == (l = I.replace(/^data-cke-saved-/, "")) || h[l] || (delete p[I], y = !0) : (delete p[I], y = !0)); if (!a.allStyles || a.hadInvalidStyle) { for (I in G) a.allStyles || C[I] ? K.push(I + ":" + G[I]) : y = !0; K.length && (p.style = K.sort().join("; ")) } else O && (p.style = O); if (!a.allClasses ||
                        a.hadInvalidClass) { for (I = 0; I < B.length; ++I)(a.allClasses || r[B[I]]) && k.push(B[I]); k.length && (p["class"] = k.sort().join(" ")); D && k.length < D.split(/\s+/).length && (y = !0) } else D && (p["class"] = D); y && (g = 1); if (!f.skipFinalValidation && !m(b)) return e.push(b), 1
                ...
                var d = a.name; if (r.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(v()) : (a.parent && c.push({ check: "it", el: a.parent }), a.remove()); else if (r.$block[d] || "tr" == d) if ("br" == b) a.previous && !J(a.previous) && (b = v(), b.insertBefore(a)), a.next && !J(a.next) && (b = v(), b.insertAfter(a)), a.replaceWithChildren(); else {
                    var d = a.children, e; b: { e = r[b]; for (var f = 0, g = d.length, n; f < g; ++f)if (n = d[f], n.type == CKEDITOR.NODE_ELEMENT && !e[n.name]) { e = !1; break b } e = !0 } if (e) a.name = b, a.attributes =
                ...
                var c = b.getDefinition(), d = c.attributes, e = c.styles, f, g, n, r; if (a.name != c.element) return !1; for (f in d) if ("class" == f) for (c = d[f].split(/\s+/), n = a.classes.join("|"); r = c.pop();) { if (-1 == n.indexOf(r)) return !1 } else if (a.attributes[f] != d[f]) return !1; for (g in e) if (a.styles[g] !=
                ...
                allow: function (b, c, d) {
                    ...
                    a.forEach(function (a) {
                        if (a.type == CKEDITOR.NODE_ELEMENT) { if ("off" == a.attributes["data-cke-filter"]) return !1; if (!b || "span" != a.name || !~CKEDITOR.tools.object.keys(a.attributes).join("|").indexOf("data-cke-")) if (n = z(e, a, f, B), n & 1) p = !0; else if (n & 2) return !1 } else if (a.type == CKEDITOR.NODE_COMMENT && a.value.match(/^\{cke_protected\}(?!\{C\})/)) {
                            var c; a: {
                                var d = decodeURIComponent(a.value.replace(/^\{cke_protected\}/, "")); c = []; var r, D, m; if (g) for (D = 0; D < g.length; ++D)if ((m = d.match(g[D])) && m[0].length == d.length) {
                                    c =
                                    !0; break a
                                } d = CKEDITOR.htmlParser.fragment.fromHtml(d); 1 == d.children.length && (r = d.children[0]).type == CKEDITOR.NODE_ELEMENT && z(e, r, c, B); c = !c.length
                            } c || f.push(a)
                        }
                    }, null, !0); f.length && (p = !0); var D; a = []; d = G[d || (this.editor ? this.editor.enterMode : CKEDITOR.ENTER_P)]; for (var y; c = f.pop();)c.type == CKEDITOR.NODE_ELEMENT ? E(c, d, a) : c.remove(); for (; D = a.pop();)if (c = D.el, c.parent) switch (y = r[c.parent.name] || r.span, D.check) {
                        case "it": r.$removeEmpty[c.name] && !c.children.length ? E(c, d, a) : m(c) || E(c, d, a); break; case "el-up": c.parent.type ==
                            CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || E(c, d, a); break; case "parent-down": c.parent.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || y[c.name] || E(c.parent, d, a)
                    }return p
                ...
                addContentForms: function (a) { if (!this.disabled && a) { var b, c, d = [], e; for (b = 0; b < a.length && !e; ++b)c = a[b], ("string" == typeof c || c instanceof CKEDITOR.style) && this.check(c) && (e = c); if (e) { for (b = 0; b < a.length; ++b)d.push(H(a[b], e)); this.addTransformations(d) } } }, addElementCallback: function (a) { this.elementCallbacks || (this.elementCallbacks = []); this.elementCallbacks.push(a) }, addFeature: function (a) {
                    ...
                    var b, c; if (!this.disabled && a) {
                        var d = this._.transformations, e; for (e = 0; e < a.length; ++e) {
                            b = a[e]; var f = void 0, g = void 0, n = void 0, r = void 0, p = void 0, B = void 0; c = []; for (g = 0; g < b.length; ++g)n = b[g], "string" == typeof n ? (n = n.split(/\s*:\s*/), r = n[0], p = null, B = n[1]) : (r = n.check, p = n.left, B = n.right), f || (f = n, f = f.element ? f.element : r ? r.match(/^([a-z0-9]+)/i)[0] :
                                f.left.getDefinition().element), p instanceof CKEDITOR.style && (p = y(p)), c.push({ check: r == f ? null : r, left: p, right: "string" == typeof B ? K(B) : B }); b = f; d[b] || (d[b] = []); d[b].push(c)
                        }
                    }
                    ...
                    if (this.disabled) return !0; if (CKEDITOR.tools.isArray(a)) { for (var d = a.length; d--;)if (this.check(a[d], b, c)) return !0; return !1 } var e, f; if ("string" == typeof a) {
                        ...
                        e.classes = d = d ? d.split(/\s*,\s*/) : []; e.styles = q(n); e.attributes = q(e.attributes); e.children = []; d.length && (e.attributes["class"] = d.join(" ")); n && (e.attributes.style = CKEDITOR.tools.writeCssText(e.styles))
                    } else e = a.getDefinition(), n = e.styles, d = e.attributes || {}, n && !CKEDITOR.tools.isEmpty(n) ? (n = D(n), d.style = CKEDITOR.tools.writeCssText(n, !0)) : n = {}, e = { name: e.element, attributes: d, classes: d["class"] ? d["class"].split(/\s+/) : [], styles: n, children: [] }; var n = CKEDITOR.tools.clone(e), r = [], p; if (!1 !== b && (p = this._.transformations[e.name])) {
                        for (d =
                            0; d < p.length; ++d)u(this, e, p[d]); t(e)
                    } z(this, n, r, { doFilter: !0, doTransform: !1 !== b, skipRequired: !c, skipFinalValidation: !c }); 0 < r.length ? c = !1 : ((b = e.attributes["class"]) && (e.attributes["class"] = e.attributes["class"].split(" ").sort().join(" ")), c = CKEDITOR.tools.objectCompare(e.attributes, n.attributes, !0), b && (e.attributes["class"] = b)); "string" == typeof a && (this._.cachedChecks[f] = c); return c
            ...
            }; var T = { styles: 1, attributes: 1, classes: 1 }, O = { styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses" }, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, I = { styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/ }, N = /^cke:(object|embed|param)$/, n = /^(object|embed|param)$/, C; C = CKEDITOR.filter.transformationsTools = {
                sizeToStyle: function (a) {
                    ...
                    if ("string" == typeof b) a.name = b; else {
                        var c = b.getDefinition(), d = c.styles, e = c.attributes, f, n, g, r; a.name = c.element; for (f in e) if ("class" ==
    ...
    CKEDITOR.scriptLoader = function () {
        var a = {}, d = {}; return {
            load: function (b, c, f, e) {
                var k = "string" == typeof b; k && (b = [b]); f || (f = CKEDITOR); var h = b.length, l = h, q = [], g = [], w = function (a) { c && (k ? c.call(f, a) : c.call(f, q, g)) }; if (0 === l) w(!0); else {
                    var x = function (a, b) { (b ? q : g).push(a); 0 >= --l && (e && CKEDITOR.document.getDocumentElement().removeStyle("cursor"), w(b)) }, z = function (b, c) { a[b] = 1; var e = d[b]; delete d[b]; for (var f = 0; f < e.length; f++)e[f](b, c) }, A = function (b) {
                        if (a[b]) x(b, !0); else {
            ...
            var e = {}, k = function (b) {
                a.call(this, b, function (a) {
                    CKEDITOR.tools.extend(e, a); var b = [], g; for (g in a) {
                        var h = a[g], x = h && h.requires; if (!d[g]) { if (h.icons) for (var z = h.icons.split(","), A = z.length; A--;)CKEDITOR.skin.addIcon(z[A], h.path + "icons/" + (CKEDITOR.env.hidpi && h.hidpi ? "hidpi/" : "") + z[A] + ".png"); h.isSupportedEnvironment = h.isSupportedEnvironment || function () { return !0 }; d[g] = 1 } if (x) for (x.split && (x =
                            x.split(",")), h = 0; h < x.length; h++)e[x[h]] || b.push(x[h])
    ...
    (function () {
        ...
        function l(a) { CKEDITOR.skin.loadPart("editor", function () { q(a) }) } function q(a) { CKEDITOR.lang.load(a.config.language, a.config.defaultLanguage, function (b, c) { var d = a.config.title; a.langCode = b; a.lang = CKEDITOR.tools.prototypedCopy(c); a.title = "string" == typeof d || !1 === d ? d : [a.lang.editor, a.name].join(", "); a.config.contentsLangDirection || (a.config.contentsLangDirection = a.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? a.element.getDirection(1) : a.lang.dir); a.fire("langLoaded"); g(a) }) } function g(a) {
                ...
                function (b) {
                    var d = [], e = [], f = []; a.plugins = CKEDITOR.tools.extend({}, a.plugins, b); for (var g in b) {
                        ...
                        if (!a.isDestroyed() && !a.isDetached()) {
                            for (var b = ["beforeInit", "init", "afterInit"], f = 0; f < b.length; f++)for (var g = 0; g < d.length; g++) { var p = d[g]; 0 === f && e[g] && p.lang && p.langEntries && (a.lang[p.name] = p.langEntries[e[g]]); if (p[b[f]]) p[b[f]](a) } a.fireOnce("pluginsLoaded"); c.keystrokes && a.setKeystroke(a.config.keystrokes);
        ...
        } function x() { var a = this.element; if (a && this.elementMode != CKEDITOR.ELEMENT_MODE_APPENDTO) { var b = this.getData(); this.config.htmlEncodeOutput && (b = CKEDITOR.tools.htmlEncode(b)); a.is("textarea") ? a.setValue(b) : a.setHtml(b); return !0 } return !1 } function z(a, b) {
            function c(a) {
                ...
                var l = a[k], r = l.startContainer.getAscendant("tr", !0); c(l) ? (f || (f = r.getAscendant("table").clone(), f.append(r.getAscendant({ thead: 1, tbody: 1, tfoot: 1 }).clone()), e.append(f),
                    f = f.findOne("thead, tbody, tfoot")), g && g.equals(r) || (g = r, h = r.clone(), f.append(h)), h.append(d(l))) : e.append(l.cloneContents())
            ...
            }, destroy: function (a) { var b = CKEDITOR.filter.instances, c = this; this.fire("beforeDestroy"); !a && x.call(this); this.editable(null); this.filter && delete this.filter; CKEDITOR.tools.array.forEach(CKEDITOR.tools.object.keys(b), function (a) { a = b[a]; c === a.editor && a.destroy() }); delete this.activeFilter; this.status = "destroyed"; this.fire("destroy"); this.removeAllListeners(); CKEDITOR.remove(this); CKEDITOR.fire("instanceDestroyed", null, this) }, elementPath: function (a) {
                if (!a) {
                    a =
    ...
    (function () {
        function a(a) { return a.attributes["data-cke-survive"] ? !1 : "a" == a.name && a.attributes.href || CKEDITOR.dtd.$removeEmpty[a.name] } var d = CKEDITOR.tools.extend({ table: 1, ul: 1, ol: 1, dl: 1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul, CKEDITOR.dtd.ol, CKEDITOR.dtd.dl), b = { ol: 1, ul: 1 }, c = CKEDITOR.tools.extend({}, { html: 1 }, CKEDITOR.dtd.html, CKEDITOR.dtd.body, CKEDITOR.dtd.head, { style: 1, script: 1 }), f = { ul: "li", ol: "li", dl: "dd", table: "tbody", tbody: "tr", thead: "tr", tfoot: "tr", tr: "td" }; CKEDITOR.htmlParser.fragment.fromHtml =
            function (e, k, h) {
                function l(a) { var b; if (0 < m.length) for (var c = 0; c < m.length; c++) { var d = m[c], e = d.name, f = CKEDITOR.dtd[e], g = v.name && CKEDITOR.dtd[v.name]; g && !g[e] || a && f && !f[a] && CKEDITOR.dtd[a] ? e == v.name && (w(v, v.parent, 1), c--) : (b || (q(), b = 1), d = d.clone(), d.parent = v, v = d, m.splice(c, 1), c--) } } function q() { for (; M.length;)w(M.shift(), v) } function g(a) {
                ...
                } function w(b, c, d) { c = c || v || t; var e = v; void 0 === b.previous && (x(c, b) && (v = c, A.onTagOpen(h, {}), b.returnPoint = c = v), g(b), a(b) && !b.children.length || c.add(b), "pre" == b.name && (E = !1), "textarea" == b.name && (J = !1)); b.returnPoint ? (v = b.returnPoint, delete b.returnPoint) : v = d ? c : e } function x(a, b) {
                    ...
                    if (a(f)) m.push(f); else {
                        if ("pre" == e) E = !0; else { if ("br" == e && E) { v.add(new CKEDITOR.htmlParser.text("\n")); return } "textarea" == e && (J = !0) } if ("br" == e) M.push(f); else {
                            for (; !(h = (g = v.name) ? CKEDITOR.dtd[g] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || v.isUnknown || h[e]);)if (v.isOptionalClose) A.onTagClose(g); else if (e in b && g in b) g = v.children, (g = g[g.length - 1]) && "li" == g.name || w(g = new CKEDITOR.htmlParser.element("li"), v), !f.returnPoint && (f.returnPoint = v), v = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !z(e, g)) A.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !z(e, g)) !f.returnPoint && (f.returnPoint = v), v = v.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(v), v.parent) w(v, v.parent, 1); else { f.isOrphan = 1; break } l(e); q(); f.parent = v; f.isEmpty ? w(f) : v = f
                        }
                    }
                    ...
                    for (var b = m.length - 1; 0 <= b; b--)if (a == m[b].name) { m.splice(b, 1); return } for (var c = [], d = [], e = v; e != t && e.name != a;)e._.isBlockLike || d.unshift(e), c.push(e), e = e.returnPoint || e.parent; if (e != t) {
                        for (b = 0; b < c.length; b++) { var f = c[b]; w(f, f.parent) } v =
                            e; e._.isBlockLike && q(); w(e, e.parent); e == v && (v = v.parent); m = m.concat(d)
                    } "body" == a && (h = !1)
                }; A.onText = function (a) { if (!(v._.hasInlineStarted && !M.length || E || J) && (a = CKEDITOR.tools.ltrim(a), 0 === a.length)) return; var b = v.name, e = b ? CKEDITOR.dtd[b] || (v._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c; if (!J && !e["#"] && b in d) A.onTagOpen(f[b] || ""), A.onText(a); else { q(); l(); E || J || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " ")); a = new CKEDITOR.htmlParser.text(a); if (x(v, a)) this.onTagOpen(h, {}, 0, 1); v.add(a) } }; A.onCDATA =
                    function (a) { v.add(new CKEDITOR.htmlParser.cdata(a)) }; A.onComment = function (a) { q(); l(); v.add(new CKEDITOR.htmlParser.comment(a)) }; A.parse(e); for (q(); v != t;)w(v, v.parent, 1); g(t); return t
        ...
        function a() { this.rules = [] } function d(b, c, d, e) { var k, h; for (k in c) (h = b[k]) || (h = b[k] = new a), h.add(c[k], d, e) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
            ...
            add: function (a, c, d) { this.rules.splice(this.findIndex(c), 0, { value: a, priority: c, options: d }) }, addMany: function (a,
                c, d) { for (var e = [this.findIndex(c), 0], k = 0, h = a.length; k < h; k++)e.push({ value: a[k], priority: c, options: d }); this.rules.splice.apply(this.rules, e) }, findIndex: function (a) { for (var c = this.rules, d = c.length - 1; 0 <= d && a < c[d].priority;)d--; return d + 1 }, exec: function (a, c) {
                    var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, e = Array.prototype.slice.call(arguments, 1), k = this.rules, h = k.length, l, q, g, w; for (w = 0; w < h; w++)if (d && (l = c.type, q = c.name), g = k[w], !(a.nonEditable && !g.options.applyToAll ||
    ...
    (function () {
        function a(a, d) {
            function g(a) { return a || CKEDITOR.env.needsNbspFiller ? new CKEDITOR.htmlParser.text(" ") : new CKEDITOR.htmlParser.element("br", { "data-cke-bogus": 1 }) } function r(a, d) {
                return function (f) {
                    if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var n = [], r = b(f), B, h; if (r) for (p(r, 1) && n.push(r); r;)e(r) && (B = c(r)) && p(B) && ((h = c(B)) && !e(h) ? n.push(B) : (g(D).insertAfter(B), B.remove())), r = r.previous; for (r = 0; r < n.length; r++)n[r].remove(); if (n = !a || !1 !== ("function" == typeof d ? d(f) : d)) D || CKEDITOR.env.needsBrFiller ||
            ...
            } var B = { elements: {} }, D = "html" == d, h = CKEDITOR.tools.extend({}, u), y; for (y in h) "#" in J[y] || delete h[y]; for (y in h) B.elements[y] = r(D, a.config.fillEmptyBlocks); B.root = r(D, !1); B.elements.br = function (a) {
                return function (b) {
        ...
        } function g(a, b) { return a.replace(b, function (a, b, c) { 0 === a.indexOf("\x3ctextarea") && (a = b + z(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") + "\x3c/textarea\x3e"); return "\x3ccke:encoded\x3e" + encodeURIComponent(a) + "\x3c/cke:encoded\x3e" }) } function w(a) { return a.replace(O, function (a, b) { return decodeURIComponent(b) }) } function x(a) {
            return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
                function (a) { return "\x3c!--" + v + "{C}" + encodeURIComponent(a).replace(/--/g, "%2D%2D") + "--\x3e" })
        } function z(a) { return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }) } function A(a, b) { var c = b._.dataStore; return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g, function (a, b) { return decodeURIComponent(b) }).replace(/\{cke_protected_(\d+)\}/g, function (a, b) { return c && c[b] || "" }) } function t(a, b) {
            var c = [], d = b.config.protectedSource, e = b._.dataStore || (b._.dataStore =
                ...
                }); a = a.replace(/<\w+(?:\s+(?:(?:[^\s=>]+\s*=\s*(?:[^'"\s>]+|'[^']*'|"[^"]*"))|[^\s=\/>]+))+\s*\/?>/g, function (a) { return a.replace(/\x3c!--\{cke_protected\}([^>]*)--\x3e/g, function (a, b) { e[e.id] = decodeURIComponent(b); return "{cke_protected_" + e.id++ + "}" }) }); return a = a.replace(/<(title|iframe|textarea)([^>]*)>([\s\S]*?)<\/\1>/g, function (a, c, d, e) { return "\x3c" + c + d + "\x3e" + A(z(e), b) + "\x3c/" + c + "\x3e" })
            ...
            e, f = this; this.editor = b; this.dataFilter = c = new CKEDITOR.htmlParser.filter; this.htmlFilter = e = new CKEDITOR.htmlParser.filter; this.writer = new CKEDITOR.htmlParser.basicWriter; c.addRules(F); c.addRules(H, { applyToAll: !0 }); c.addRules(a(b, "data"), { applyToAll: !0 }); e.addRules(y); e.addRules(K, { applyToAll: !0 }); e.addRules(a(b, "html"), { applyToAll: !0 }); b.on("toHtml", function (a) {
                a = a.data; var c = a.dataValue, e, c = m(c), c = t(c, b), c = g(c, T), c = q(c), c = g(c, G), c = c.replace(p, "$1cke:$2"), c = c.replace(N, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
                ...
                a.data.filter.applyTo(a.data.dataValue,
                    !1, !0)
            }, null, null, 11); b.on("toDataFormat", function (a) { var c = a.data.dataValue, d = f.writer; d.reset(); c.writeChildrenHtml(d); c = d.getHtml(!0); c = z(c); c = A(c, b); a.data.dataValue = c }, null, null, 15)
        }; CKEDITOR.htmlDataProcessor.prototype = {
            toHtml: function (a, b, c, d) {
                var e = this.editor, f, g, r, p; b && "object" == typeof b ? (f = b.context, c = b.fixForBody, d = b.dontFilter, g = b.filter, r = b.enterMode, p = b.protectedWhitespaces) : f = b; f || null === f || (f = e.editable().getName()); return e.fire("toHtml", {
                    dataValue: a, context: f, fixForBody: c, dontFilter: d,
                    filter: g || e.filter, enterMode: r || e.enterMode, protectedWhitespaces: p
                }).dataValue
            }, toDataFormat: function (a, b) { var c, d, e; b && (c = b.context, d = b.filter, e = b.enterMode); c || null === c || (c = this.editor.editable().getName()); return this.editor.fire("toDataFormat", { dataValue: a, filter: d || this.editor.filter, context: c, enterMode: e || this.editor.enterMode }).dataValue }, protectSource: function (a) { return t(a, this.editor) }, unprotectSource: function (a) { return A(a, this.editor) }, unprotectRealComments: function (a) { return z(a) }
        }; var M =
            /(?:&nbsp;|\xa0)$/, v = "{cke_protected}", J = CKEDITOR.dtd, E = "caption colgroup col thead tfoot tbody".split(" "), u = CKEDITOR.tools.extend({}, J.$blockLimit, J.$block), F = { elements: { input: h, textarea: h } }, H = {
            ...
            }, y = { elements: { embed: function (a) { var b = a.parent; if (b && "object" == b.name) { var c = b.attributes.width, b = b.attributes.height; c && (a.attributes.width = c); b && (a.attributes.height = b) } }, a: function (a) { var b = a.attributes; if (!(a.children.length || b.name || b.id || a.attributes["data-cke-saved-name"])) return !1 } } }, K = {
            ...
            }; CKEDITOR.env.ie && (K.attributes.style = function (a) { return a.replace(/(^|;)([^\:]+)/g, function (a) { return a.toLowerCase() }) }); var r = /<(a|area|img|input|source)\b([^>]*)>/gi, D = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, B = /^(href|src|name)$/i, G = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, T = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi, O = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, p = /(<\/?)((?:object|embed|param|html|body|head|title)([\s][^>]*)?>)/gi,
                I = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, N = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi; m = function () {
        ...
        function l(a, b, c) { return !1 !== a.config.autoParagraph && a.activeEnterMode != CKEDITOR.ENTER_BR && (a.editable().equals(c) && !b || b && "true" == b.getAttribute("contenteditable")) } function q(a) { return a.activeEnterMode != CKEDITOR.ENTER_BR && !1 !== a.config.autoParagraph ? a.activeEnterMode == CKEDITOR.ENTER_DIV ? "div" : "p" : !1 } function g(a) { a && a.isEmptyInlineRemoveable() && a.remove() } function w(a) { var b = a.editor; b.getSelection().scrollIntoView(); setTimeout(function () { b.fire("saveSnapshot") }, 0) } function x(a, b, c) {
                                ...
                                null, -1); if (CKEDITOR.env.edge && 14 < CKEDITOR.env.version) { var d = function () { var b = a.editable(); null != a._.previousScrollTop && b.getDocument().equals(CKEDITOR.document) && (b.$.scrollTop = a._.previousScrollTop, a._.previousScrollTop = null, this.removeListener("scroll", d)) }; this.on("scroll", d) } a.focusManager.add(this); this.equals(CKEDITOR.document.getActive()) && (this.hasFocus = !0, a.once("contentDom", function () { a.focusManager.focus(this) }, this)); this.isInline() && this.changeAttr("tabindex", a.tabIndex); if (!this.is("textarea")) {
                                    ...
                                    this.getDocument(); a.window = this.getWindow(); var g = a.document; this.changeAttr("spellcheck", !a.config.disableNativeSpellChecker); var f = a.config.contentsLangDirection; this.getDirection(1) != f && this.changeAttr("dir", f); var B = CKEDITOR.getCss(); if (B) {
                                        ...
                                        if (a.readOnly) return !0; var c = b.data.domEvent.getKey(), d, g = a.getSelection(); if (0 !== g.getRanges().length) {
                                            if (c in
                                                l) {
                                                    var f; b = g.getRanges()[0]; var r = b.startPath(), B, D, G, c = 8 == c, q = !1; if (CKEDITOR.env.ie && 11 > CKEDITOR.env.version && g.getSelectedElement()) f = g.getSelectedElement(); else if (e(g)) {
                                                        var m = new CKEDITOR.dom.walker(b), w = b.collapsed ? b.startContainer : m.next(), q = !1, K; if (b.checkStartOfBlock()) { K = b.startPath().block || b.startPath().blockLimit; var t = K.getName(); K = -1 !== CKEDITOR.tools.array.indexOf(["dd", "dt", "li"], t) && null === K.getPrevious() } else K = !1; if (K) {
                                                            for (; w && !q;)q = w.$.nodeName.toLowerCase(), q = !!H[q], w = m.next();
                                                            m = h(b.startPath()); w = h(b.endPath()); q = q || m !== w
                                                    ...
                                                    var c = 8 == c, d = b.getRanges()[0]; b = d.startPath(); if (d.collapsed) a: {
                                                        var e = b.block; if (e && d[c ? "checkStartOfBlock" : "checkEndOfBlock"](!0) && d.moveToClosestEditablePosition(e, !c) && d.collapsed) {
                                                            if (d.startContainer.type == CKEDITOR.NODE_ELEMENT) { var g = d.startContainer.getChild(d.startOffset - (c ? 1 : 0)); if (g && g.type == CKEDITOR.NODE_ELEMENT && g.is("hr")) { a.fire("saveSnapshot"); g.remove(); b = !0; break a } } d = d.startPath().block; if (!d || d && d.contains(e)) b =
                                                                void 0; else { a.fire("saveSnapshot"); var f; (f = (c ? d : e).getBogus()) && f.remove(); f = a.getSelection(); g = f.createBookmarks(); (c ? e : d).moveChildren(c ? d : e, !1); b.lastElement.mergeSiblings(); x(e, d, !c); f.selectBookmarks(g); b = !0 }
                                                        } else b = !1
                                                    } else c = d, f = b.block, d = c.endPath().block, f && d && !f.equals(d) ? (a.fire("saveSnapshot"), (e = f.getBogus()) && e.remove(), c.enlarge(CKEDITOR.ENLARGE_INLINE), c.deleteContents(), d.getParent() && (d.moveChildren(f, !1), b.lastElement.mergeSiblings(), x(f, d, !0)), c = a.getSelection().getRanges()[0],
            ...
            function () {
                function a(b) { return b.type == CKEDITOR.NODE_ELEMENT } function b(c, d) {
                    var e, g, f, p, h = [], k = d.range.startContainer; e = d.range.startPath(); for (var k = m[k.getName()], r = 0, B = c.getChildren(), D = B.count(), G = -1, l = -1, I = 0, N = e.contains(m.$list); r < D; ++r)e = B.getItem(r), a(e) ? (f = e.getName(), N && f in CKEDITOR.dtd.$list ? h = h.concat(b(e, d)) : (p = !!k[f], "br" != f || !e.data("cke-eol") || r && r != D - 1 || (I = (g = r ? h[r - 1].node : B.getItem(r + 1)) && (!a(g) || !g.is("br")), g = g && a(g) && m.$block[g.getName()]), -1 != G || p || (G = r), p || (l = r), h.push({
                        isElement: 1,
                        isLineBreak: I, isBlock: e.isBlockBoundary(), hasBlockSibling: g, node: e, name: f, allowed: p
                    }), g = I = 0)) : h.push({ isElement: 0, node: e, allowed: 1 }); -1 < G && (h[G].firstNotAllowed = 1); -1 < l && (h[l].lastNotAllowed = 1); return h
                } function d(b, c) { var e = [], g = b.getChildren(), f = g.count(), p, h = 0, k = m[c], B = !b.is(m.$inline) || b.is("br"); for (B && e.push(" "); h < f; h++)p = g.getItem(h), a(p) && !p.is(k) ? e = e.concat(d(p, c)) : e.push(p); B && e.push(" "); return e } function e(b) { return a(b.startContainer) && b.startContainer.getChild(b.startOffset - 1) } function f(b) {
                    return b &&
                        a(b) && (b.is(m.$removeEmpty) || b.is("a") && !b.isBlockBoundary())
                } function h(b, c, d, e) { var g = b.clone(), f, r; g.setEndAt(c, CKEDITOR.POSITION_BEFORE_END); (f = (new CKEDITOR.dom.walker(g)).next()) && a(f) && p[f.getName()] && (r = f.getPrevious()) && a(r) && !r.getParent().equals(b.startContainer) && d.contains(r) && e.contains(f) && f.isIdentical(r) && (f.moveChildren(r), f.remove(), h(b, c, d, e)) } function k(b, c) {
                ...
                } var m = CKEDITOR.dtd, p = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1 }, I = { p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1 }, N = CKEDITOR.tools.extend({}, m.$inline); delete N.br; return function (p, C, L, w) {
                    var t = p.editor, u = !1, x; "unfiltered_html" == C && (C = "html", u = !0); if (!w.checkReadOnly()) {
                        var z = (new CKEDITOR.dom.elementPath(w.startContainer, w.root)).blockLimit ||
                            ...
                            } for (; (H = e(u)) && a(H) && H.isBlockBoundary() && V.contains(H);)u.moveToPosition(H, CKEDITOR.POSITION_BEFORE_END); h(u, C.blockLimit, V, F); S && (u.setEndBefore(S), u.collapse(), S.remove()); S = u.startPath(); if (A = S.contains(f, !1, 1)) x = u.splitElement(A), C.inlineStylesRoot = A, C.inlineStylesPeak = S.lastElement; S = u.createBookmark(); v && (g(A), g(x)); (A = S.startNode.getPrevious(c)) && a(A) && f(A) && z.push(A); (A = S.startNode.getNext(c)) && a(A) &&
                                f(A) && z.push(A); for (A = S.startNode; (A = A.getParent()) && f(A);)z.push(A); u.moveToBookmark(S); x = p.getHtml(); x = "" === x || x.match(M); t.enterMode === CKEDITOR.ENTER_DIV && x && ((t = p.getFirst()) && t.remove(), w.setStartAt(p, CKEDITOR.POSITION_AFTER_START), w.collapse(!0)); if (p = L) {
                                    p = C.range; if ("text" == C.type && C.inlineStylesRoot) { w = C.inlineStylesPeak; t = w.getDocument().createText("{cke-peak}"); for (x = C.inlineStylesRoot.getParent(); !w.equals(x);)t = t.appendTo(w.clone()), w = w.getParent(); L = t.getOuterHtml().split("{cke-peak}").join(L) } w =
                                        C.blockLimit.getName(); if (/^\s+|\s+$/.test(L) && "span" in CKEDITOR.dtd[w]) { var J = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e'; L = J + L + J } L = C.editor.dataProcessor.toHtml(L, { context: null, fixForBody: !1, protectedWhitespaces: !!J, dontFilter: C.dontFilter, filter: C.editor.activeFilter, enterMode: C.editor.activeEnterMode }); w = p.document.createElement("body"); w.setHtml(L); J && (w.getFirst().remove(), w.getLast().remove()); if ((J = p.startPath().block) && (1 != J.getChildCount() || !J.getBogus())) a: {
                                            var Q; if (1 ==
                                                w.getChildCount() && a(Q = w.getFirst()) && Q.is(I) && !Q.hasAttribute("contenteditable")) { J = Q.getElementsByTag("*"); p = 0; for (x = J.count(); p < x; p++)if (t = J.getItem(p), !t.is(N)) break a; Q.moveChildren(Q.getParent(1)); Q.remove() }
                                        } C.dataWrapper = w; p = L
                                } if (p) {
                                    Q = C.range; p = Q.document; w = C.blockLimit; x = 0; var E, J = [], ca, P; L = S = 0; var U, t = Q.startContainer; H = C.endPath.elements[0]; var R, u = H.getPosition(t), z = !!H.getCommonAncestor(t) && u != CKEDITOR.POSITION_IDENTICAL && !(u & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED),
                                        t = b(C.dataWrapper, C); for (C.editor.enterMode !== CKEDITOR.ENTER_BR && k(t, Q); x < t.length; x++) {
                                            u = t[x]; if (v = u.isLineBreak) v = Q, A = w, F = V = void 0, u.hasBlockSibling ? v = 1 : (V = v.startContainer.getAscendant(m.$block, 1)) && V.is({ div: 1, p: 1 }) ? (F = V.getPosition(A), F == CKEDITOR.POSITION_IDENTICAL || F == CKEDITOR.POSITION_CONTAINS ? v = 0 : (A = v.splitElement(V), v.moveToPosition(A, CKEDITOR.POSITION_AFTER_START), v = 1)) : v = 0; if (v) L = 0 < x; else {
                                                v = Q.startPath(); !u.isBlock && l(C.editor, v.block, v.blockLimit) && (P = q(C.editor)) && (P = p.createElement(P),
                                                    P.appendBogus(), Q.insertNode(P), CKEDITOR.env.needsBrFiller && (E = P.getBogus()) && E.remove(), Q.moveToPosition(P, CKEDITOR.POSITION_BEFORE_END)); if ((v = Q.startPath().block) && !v.equals(ca)) { if (E = v.getBogus()) E.remove(), J.push(v); ca = v } u.firstNotAllowed && (S = 1); if (S && u.isElement) {
                                                        v = Q.startContainer; for (A = null; v && !m[v.getName()][u.name];) { if (v.equals(w)) { v = null; break } A = v; v = v.getParent() } if (v) A && (U = Q.splitElement(A), C.zombies.push(U), C.zombies.push(A)); else {
                                                            A = w.getName(); R = !x; v = x == t.length - 1; A = d(u.node, A); V = [];
                                                    ...
                                                    } if (R) { for (; v = R.pop();)Q.insertNode(v); R = 0 } else Q.insertNode(u.node); u.lastNotAllowed && x < t.length - 1 && ((U = z ? H : U) && Q.setEndAt(U, CKEDITOR.POSITION_AFTER_START), S = 0); Q.collapse()
                                            }
                ...
                function a(b, c) { var d = b.getParent(); if (d.is(CKEDITOR.dtd.$inline)) b[c ? "insertBefore" : "insertAfter"](d) } function b(c, d, e) {
                    ...
                    list: {
                        ...
                        function a(c) {
                            var e = [], g, f = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), r = {}; f.guard = function (a, f) {
                                if (a.type == CKEDITOR.NODE_ELEMENT) { var l = "visited_" + (f ? "out" : "in"); if (a.getCustomData(l)) return; CKEDITOR.dom.element.setMarker(r, a, l, 1) } if (f && h && a.equals(h)) g = c.clone(), g.setEndAt(h, CKEDITOR.POSITION_BEFORE_END), e.push(g); else if (!f && k && a.equals(k)) g = c.clone(), g.setStartAt(k,
                            ...
                            }; f.lastForward(); CKEDITOR.dom.element.clearAllMarkers(r); return e
                        } function b(a, c) {
    ...
    (function () {
        function a(a) { return CKEDITOR.plugins.widget && CKEDITOR.plugins.widget.isDomWidget(a) } function d(b, c) {
        ...
        } function k() { F = !0; u || (h.call(this), u = CKEDITOR.tools.setTimeout(h, 200, this)) } function h() { u = null; F && (CKEDITOR.tools.setTimeout(e, 0, this), F = !1) } function l(a) { return H(a) || a.type == CKEDITOR.NODE_ELEMENT && !a.is(CKEDITOR.dtd.$empty) ? !0 : !1 } function q(a) {
            ...
            var c = a && a.removeCustomData("cke-fillingChar"); if (c) {
                ...
                } c.setText(x(c.getText(), 1)); f && (c = a.getDocument().$, d = c.getSelection(), c = c.createRange(), c.setStart(f[0].node, f[0].offset), c.collapse(!0), d.removeAllRanges(), d.addRange(c), d.extend(f[1].node, f[1].offset))
            }
        } function x(a, b) { return b ? a.replace(J, function (a, b) { return b ? " " : "" }) : a.replace(v, "") } function z(a, b) {
            ...
            "function" != typeof window.getSelection, M = 1, v = CKEDITOR.tools.repeat("​", 7), J = new RegExp(v + "( )?", "g"), E, u, F, H = CKEDITOR.dom.walker.invisible(1), y = function () {
                ...
                function b() { var a = c.getSelection(); a && a.removeAllRanges() } var c = a.editor; c.on("contentDom", function () {
                    function a() { u = new CKEDITOR.dom.selection(c.getSelection()); u.lock() } function b() {
                        ...
                        "focusout" : "blur", function () { var a = u && (u.isFake || 2 > u.getRanges().length); CKEDITOR.env.gecko && !q && a || (c.lockSelection(u), D = 1) }, null, null, -1), n.attachListener(n, "mousedown", function () { D = 0 }); if (CKEDITOR.env.ie && !q) {
                            var t; n.attachListener(n, "mousedown", function (a) { 2 == a.data.$.button && ((a = c.document.getSelection()) && a.getType() != CKEDITOR.SELECTION_NONE || (t = c.window.getScrollPosition())) }); n.attachListener(n, "mouseup", function (a) {
                                ...
                                if (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
                                    var x, v; r.on("mousedown", function (a) {
                                        function b(a) { a = a.data.$; if (x) { var c = l.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch (d) { } x.setEndPoint(0 > v.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c); x.select() } } function c() { r.removeListener("mousemove", b); h.removeListener("mouseup", c); r.removeListener("mouseup", c); x.select() } a = a.data; if (a.getTarget().is("html") && a.$.y < r.$.clientHeight &&
                                            a.$.x < r.$.clientWidth) { x = l.$.createTextRange(); try { x.moveToPoint(a.$.clientX, a.$.clientY) } catch (d) { } v = x.duplicate(); r.on("mousemove", b); h.on("mouseup", c); r.on("mouseup", c) }
                                    })
                ...
                }, null, null, 100); c.on("key", function (a) { if ("wysiwyg" == c.mode) { var b = c.getSelection(); if (b.isFake) { var d = y[a.data.keyCode]; if (d) return d({ editor: c, selected: b.getSelectedElement(), selection: b, keyEvent: a }) } } })
                ...
                }, null, null, -1); b.on("beforeSetMode", function () { w(b.editable()) }, null, null, -1); b.on("getSnapshot", function (a) { a.data && (a.data = x(a.data)) }, b, null, 20); b.on("toDataFormat", function (a) { a.data.dataValue = x(a.data.dataValue) }, null, null, 0)
                ...
                2; CKEDITOR.SELECTION_ELEMENT = 3; CKEDITOR.dom.selection = function (a) {
                ...
                }; CKEDITOR.tools.extend(CKEDITOR.dom.selection, { _removeFillingCharSequenceString: x, _createFillingCharSequenceNode: g, FILLING_CHAR_SEQUENCE: v }); CKEDITOR.dom.selection.prototype = {
                    getNative: function () { return void 0 !== this._.cache.nativeSel ? this._.cache.nativeSel : this._.cache.nativeSel = m ? this.document.$.selection : this.document.getWindow().$.getSelection() }, getType: m ? function () {
                            ...
                            function a(b) { return (new CKEDITOR.dom.node(b)).getIndex() } var b = function (b, c) {
                                b = b.duplicate(); b.collapse(c); var d = b.parentElement(); if (!d.hasChildNodes()) return { container: d, offset: 0 }; for (var e = d.children, g, f, h = b.duplicate(), k = 0, l = e.length - 1, r = -1, q, m; k <= l;)if (r = Math.floor((k + l) / 2), g = e[r], h.moveToElementText(g), q = h.compareEndPoints("StartToStart",
                                    b), 0 < q) l = r - 1; else if (0 > q) k = r + 1; else return { container: d, offset: a(g) }; if (-1 == r || r == e.length - 1 && 0 > q) { h.moveToElementText(d); h.setEndPoint("StartToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; e = d.childNodes; if (!h) return g = e[e.length - 1], g.nodeType != CKEDITOR.NODE_TEXT ? { container: d, offset: e.length } : { container: g, offset: g.nodeValue.length }; for (d = e.length; 0 < h && 0 < d;)f = e[--d], f.nodeType == CKEDITOR.NODE_TEXT && (m = f, h -= f.nodeValue.length); return { container: m, offset: -h } } h.collapse(0 < q ? !0 : !1); h.setEndPoint(0 <
                                        q ? "StartToStart" : "EndToStart", b); h = h.text.replace(/(\r\n|\r)/g, "\n").length; if (!h) return { container: d, offset: a(g) + (0 < q ? 0 : 1) }; for (; 0 < h;)try { f = g[0 < q ? "previousSibling" : "nextSibling"], f.nodeType == CKEDITOR.NODE_TEXT && (h -= f.nodeValue.length, m = f), g = f } catch (w) { return { container: d, offset: a(g) } } return { container: m, offset: 0 < q ? -h : m.nodeValue.length + h }
                            }; return function () {
                        ...
                        if (c) for (var c = this.root, e, h = 0; h < a.length; ++h)e = a[h], e.endContainer.equals(c) && (e.endOffset = Math.min(e.endOffset, c.getChildCount())); if (a.length) if (this.isLocked) { var k = CKEDITOR.document.getActive(); this.unlock(); this.selectRanges(a); this.lock(); k && !k.equals(this.root) && k.focus() } else {
                            var p; a: {
                                var l, N; if (1 == a.length && !(N = a[0]).collapsed && (p = N.getEnclosedNode()) && p.type == CKEDITOR.NODE_ELEMENT && (N = N.clone(), N.shrink(CKEDITOR.SHRINK_ELEMENT, !0), (l = N.getEnclosedNode()) && l.type == CKEDITOR.NODE_ELEMENT &&
                                    (p = l), "false" == p.getAttribute("contenteditable"))) break a; p = void 0
                            } if (p) this.fake(p); else if (b && b.plugins.tableselection && b.plugins.tableselection.isSupportedEnvironment(b) && d(a) && !E && !a[0]._getTableElement({ table: 1 }).hasAttribute("data-cke-tableselection-ignored")) f.call(this, a); else {
                                if (m) {
                                    l = CKEDITOR.dom.walker.whitespaces(!0); p = /\ufeff|\u00a0/; N = { table: 1, tbody: 1, tr: 1 }; 1 < a.length && (b = a[a.length - 1], a[0].setEnd(b.endContainer, b.endOffset)); b = a[0]; a = b.collapsed; var n, C, L; if ((c = b.getEnclosedNode()) &&
                                    ...
                                    k = this.getNative(); if (!k) return; this.removeAllRanges(); for (L = 0; L < a.length; L++) {
                                        if (L < a.length - 1 && (n = a[L], C = a[L + 1], p = n.clone(), p.setStart(n.endContainer, n.endOffset), p.setEnd(C.startContainer, C.startOffset), !p.collapsed && (p.shrink(CKEDITOR.NODE_ELEMENT, !0), b = p.getCommonAncestor(), p = p.getEnclosedNode(), b.isReadOnly() || p && p.isReadOnly()))) {
                                            C.setStart(n.startContainer, n.startOffset); a.splice(L--,
                                                1); continue
                                        } b = a[L]; C = this.document.$.createRange(); b.collapsed && CKEDITOR.env.webkit && q(b) && (p = g(this.root), b.insertNode(p), (n = p.getNext()) && !p.getPrevious() && n.type == CKEDITOR.NODE_ELEMENT && "br" == n.getName() ? (w(this.root), b.moveToPosition(n, CKEDITOR.POSITION_BEFORE_START)) : b.moveToPosition(p, CKEDITOR.POSITION_AFTER_END)); C.setStart(b.startContainer.$, b.startOffset); try { C.setEnd(b.endContainer.$, b.endOffset) } catch (t) {
        ...
        function a(a, b) { for (var c, d; (a = a.getParent()) && !a.equals(b);)if (a.getAttribute("data-nostyle")) c = a; else if (!d) { var e = a.getAttribute("contentEditable"); "false" == e ? c = a : "true" == e && (d = 1) } return c } function d(a, b, c, d) { return (a.getPosition(b) | d) == d && (!c.childRule || c.childRule(a)) } function b(c) {
            var e = c.document; if (c.collapsed) e = M(this, e), c.insertNode(e), c.moveToPosition(e, CKEDITOR.POSITION_BEFORE_END); else {
                var g = this.element, h = this._.definition, k, l = h.ignoreReadonly, q = l || h.includeReadonly; null ==
                    q && (q = c.root.getCustomData("cke_includeReadonly")); var m = CKEDITOR.dtd[g]; m || (k = !0, m = CKEDITOR.dtd.span); c.enlarge(CKEDITOR.ENLARGE_INLINE, 1); c.trim(); var r = c.createBookmark(), w = r.startNode, u = r.endNode, t = w, x; if (!l) { var v = c.getCommonAncestor(), l = a(w, v), v = a(u, v); l && (t = l.getNextSourceNode(!0)); v && (u = v) } for (t.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (t = 0); t;) {
                        l = !1; if (t.equals(u)) t = null, l = !0; else {
                            ...
                            for (var l = M(this, e), v = l.hasAttributes(), y = x.getCommonAncestor(),
                                z = {}, E = {}, F = {}, G = {}, U, R, Y; l && y;) { if (y.getName() == g) { for (U in h.attributes) !G[U] && (Y = y.getAttribute(R)) && (l.getAttribute(U) == Y ? E[U] = 1 : G[U] = 1); for (R in h.styles) !F[R] && (Y = y.getStyle(R)) && (l.getStyle(R) == Y ? z[R] = 1 : F[R] = 1) } y = y.getParent() } for (U in E) l.removeAttribute(U); for (R in z) l.removeStyle(R); v && !l.hasAttributes() && (l = null); l ? (x.extractContents().appendTo(l), x.insertNode(l), A.call(this, l), l.mergeSiblings(), CKEDITOR.env.ie || l.$.normalize()) : (l = new CKEDITOR.dom.element("span"), x.extractContents().appendTo(l),
                                    x.insertNode(l), A.call(this, l), l.remove(!0)); x = null
                        }
            ...
            function b() {
                ...
                var q = c.endNode, m = this; b(); for (g = d; !g.equals(q);)f = g.getNextSourceNode(), g.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(g) && (g.getName() == this.element ? z.call(this, g) : t(g, E(this)[g.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) &&
                    (b(), f = d.getNext())), g = f
            ...
            c = a.createIterator(); c.enforceRealBlocks = !0; c.enlargeBr = this._.enterMode != CKEDITOR.ENTER_BR; for (var d, e; d = c.getNextParagraph();)this.checkElementRemovable(d) && (d.is("pre") ? ((e = this._.enterMode == CKEDITOR.ENTER_BR ? null : a.document.createElement(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div")) && d.copyAttributes(e), q(d, e)) : z.call(this, d)); a.moveToBookmark(b)
        } function q(a, b) {
            ...
            } else f ? b = x(c ? [a.getHtml()] : g(a), b) : a.moveChildren(b); b.replace(a); if (d) {
            ...
            t(a, e, y[a.getName()]); g && (this._.definition.alwaysRemoveElement ? m(a, 1) : !CKEDITOR.dtd.$block[a.getName()] || this._.enterMode == CKEDITOR.ENTER_BR && !a.hasAttributes() ? m(a) : a.renameNode(this._.enterMode == CKEDITOR.ENTER_P ? "p" : "div"))
            ...
            b, c) { if (b = b && b.attributes) for (var d = 0; d < b.length; d++) { var e = b[d][0], g; if (g = a.getAttribute(e)) { var f = b[d][1]; (null === f || f.test && f.test(g) || "string" == typeof f && g == f) && a.removeAttribute(e) } } c || m(a) } function m(a, b) {
                ...
                return !0
            } function H(a, b, c) { var d = a.getRanges(); b = b ? this.removeFromRange : this.applyToRange; for (var e, g = d.createIterator(); e = g.getNextRange();)b.call(this, e, c); a.selectRanges(d) } var y = { address: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, p: 1, pre: 1, section: 1, header: 1, footer: 1, nav: 1, article: 1, aside: 1, figure: 1, dialog: 1, hgroup: 1, time: 1, meter: 1, menu: 1, command: 1, keygen: 1, output: 1, progress: 1, details: 1, datagrid: 1, datalist: 1 }, K = {
                a: 1, blockquote: 1, embed: 1, hr: 1, img: 1, li: 1, object: 1, ol: 1, table: 1, td: 1, tr: 1, th: 1, ul: 1, dl: 1,
                dt: 1, dd: 1, form: 1, audio: 1, video: 1
            }, r = /\s*(?:;\s*|$)/, D = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1), G = CKEDITOR.dom.walker.whitespaces(1); CKEDITOR.style = function (a, b) {
                if ("string" == typeof a.type) return new CKEDITOR.style.customHandlers[a.type](a); var c = a.attributes; c && c.style && (a.styles = CKEDITOR.tools.extend({}, a.styles, CKEDITOR.tools.parseCssText(c.style)), delete c.style); b && (a = CKEDITOR.tools.clone(a), J(a.attributes, b), J(a.styles, b)); c = this.element = a.element ? "string" == typeof a.element ? a.element.toLowerCase() :
                    a.element : "*"; this.type = a.type || (y[c] ? CKEDITOR.STYLE_BLOCK : K[c] ? CKEDITOR.STYLE_OBJECT : CKEDITOR.STYLE_INLINE); "object" == typeof this.element && (this.type = CKEDITOR.STYLE_OBJECT); this._ = { definition: a }
        ...
        var a = {}, d = {}, b; for (b in CKEDITOR.dtd.$blockLimit) b in CKEDITOR.dtd.$list || (a[b] = 1); for (b in CKEDITOR.dtd.$block) b in CKEDITOR.dtd.$blockLimit || b in CKEDITOR.dtd.$empty || (d[b] = 1); CKEDITOR.dom.elementPath = function (b, f) {
            var e = null, k = null, h = [], l = b, q; f = f || b.getDocument().getBody(); l || (l = f); do if (l.type == CKEDITOR.NODE_ELEMENT) {
                h.push(l); if (!this.lastElement && (this.lastElement = l, l.is(CKEDITOR.dtd.$object) || "false" == l.getAttribute("contenteditable"))) continue; if (l.equals(f)) break; if (!k && (q = l.getName(),
                    "true" == l.getAttribute("contenteditable") ? k = l : !e && d[q] && (e = l), a[q])) { if (q = !e && "div" == q) { a: { q = l.getChildren(); for (var g = 0, w = q.count(); g < w; g++) { var x = q.getItem(g); if (x.type == CKEDITOR.NODE_ELEMENT && CKEDITOR.dtd.$block[x.getName()]) { q = !0; break a } } q = !1 } q = !q } q ? e = l : k = l }
