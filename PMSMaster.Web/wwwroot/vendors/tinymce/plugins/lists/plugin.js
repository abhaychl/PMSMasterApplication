...
var lists = (function () {
    ...
    var findParentListItemsNodes = function (editor, ePMSMaster) {
      var listItemsEPMSMaster = global$5.map(ePMSMaster, function (elm) {
        var parentLi = editor.dom.getParent(elm, 'li,dd,dt', getClosestListRootElm(editor, elm));
        return parentLi ? parentLi : elm;
      });
      return global$7.unique(listItemsEPMSMaster);
    };
