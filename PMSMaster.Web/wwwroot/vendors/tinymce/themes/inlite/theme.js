...
var inlite = (function () {
    ...
    var getSelectionElements = function (editor) {
      ...
      var ePMSMaster = editor.dom.getParents(node, '*');
      return ePMSMaster;
    };
    ...
    var unwrapElements = function (editor, ePMSMaster) {
      var bookmark, dom, selection;
      dom = editor.dom;
      selection = editor.selection;
      bookmark = Bookmark.create(dom, selection.getRng());
      global$4.each(ePMSMaster, function (elm) {
    ...
    var getSelectedAnchors = function (editor) {
      var startElm, endElm, rootElm, anchorEPMSMaster, selection, dom, rng;
      selection = editor.selection;
      dom = editor.dom;
      ...
      anchorEPMSMaster = global$4.grep(getSelectedElements(rootElm, startElm, endElm), isLink);
      return anchorEPMSMaster;
    };
    ...
    var getInsertedElement = function (editor) {
      var ePMSMaster = editor.dom.select('*[data-mce-id]');
      return ePMSMaster[0];
    };
    ...
    var getHeaderTargets = function (ePMSMaster) {
      return map(filter(ePMSMaster, isValidHeader), headerTarget);
    };
    var getAnchorTargets = function (ePMSMaster) {
      return map(filter(ePMSMaster, isValidAnchor), anchorTarget);
    };
    var getTargetElements = function (elm) {
      var ePMSMaster = select('h1,h2,h3,h4,h5,h6,a:not([href])', elm);
      return ePMSMaster;
    };
    ...
    var find$3 = function (elm) {
      var ePMSMaster = getTargetElements(elm);
      return filter(getHeaderTargets(ePMSMaster).concat(getAnchorTargets(ePMSMaster)), hasTitle);
    };
